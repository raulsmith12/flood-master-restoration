                                        ...
                                        <div className="row">
                                            <div className="col-12">
                                                ...
                                                <ol className="text-white">
                                                    <li className="text-white"><strong className="text-white">Crime Scene Cleanup</strong>: Dealing with the aftermath of a crime is distressing. Our experienced technicians are trained to handle the cleanup of crime scenes with precision, efficiency, and respect for the emotional toll it takes on those affected.</li>
                                                    <li className="text-white"><strong className="text-white">Unattended Death Cleanup</strong>: The discovery of an unattended death is a challenging situation. We provide compassionate cleanup services, eliminating biohazards and restoring the affected area to a safe and hygienic condition.</li>
                                                    <li className="text-white"><strong className="text-white">Trauma Cleanup</strong>: Traumatic events demand a specialized approach. Our trauma cleanup services encompass accidents, injuries, and other traumatic incidents, ensuring a thorough and discreet restoration of the affected space.</li>
                                                    <li className="text-white"><strong className="text-white">Hoarding Cleanup</strong>: Hoarding situations can result in biohazards and pose significant health risks. Our team is adept at handling hoarding cleanup with sensitivity, addressing the associated health and safety concerns.</li>
                                                    <li className="text-white"><strong className="text-white">Infectious Disease Cleanup</strong>: With the ongoing concern for infectious diseases, our biohazard cleanup services extend to handling situations involving hazardous materials and contagious diseases. We follow strict protocols to safeguard your property and the community.</li>
                                                </ol>
                                                <h3 className="text-white text-center display-5">Why Choose Flood Master Restoration LLC?</h3>
                                                <ol className="text-white">
                                                    <li className="text-white"><strong className="text-white">24/7 Emergency Response</strong>: Biohazard incidents demand immediate attention. We offer round-the-clock emergency response services, ensuring that our team is there when you need us the most.</li>
                                                    <li className="text-white"><strong className="text-white">Certified and Trained Professionals</strong>:Our technicians are certified and trained to handle biohazard cleanup effectively. They adhere to industry standards and regulations, guaranteeing a safe and thorough cleanup process.</li>
                                                    <li className="text-white"><strong className="text-white">Discreet and Compassionate Service</strong>: We understand the sensitive nature of biohazard cleanup. Our team approaches each situation with empathy, discretion, and the utmost professionalism, respecting your privacy and emotional well-being.</li>
                                                    <li className="text-white"><strong className="text-white">State-of-the-Art Equipment</strong>: Utilizing advanced equipment and technology, we ensure that the cleanup process is not only efficient but also meets the highest standards of safety and hygiene.</li>
